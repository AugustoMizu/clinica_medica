...
<body style="margin-left: 25%; margin-right: 25%; margin-top: 10%" background="bg3.jpg">
  <div class="border border-3 rounded p-5 shadow " style="border: rgba(255, 0, 0, .5); background-color: #BFF7A3;" class="container">
    <form action="cadastroProduto_action.php" method="post" id="formCadastro" class=""> 
        ...
        <div class="mb-2 d-flex col">
          <div class="w-75">
            ...
            <input type="email" name="emailInput" maxlength="30" placeholder="Email" class="form-control " required>
          </div>
        </div>
        <div calas="mb-2">
          <div class="w-75">
            <label for="enderecoInput">Endereço</label>
            <input type="text" name="enderecoInput" maxlength="30" placeholder="Endereço" class="form-control " required>
          </div>
        </div>
        <div class="mb-2 d-flex col">
          <div class="w-50">
...
<script>
  // Alerta paciente cadastrado com sucesso
